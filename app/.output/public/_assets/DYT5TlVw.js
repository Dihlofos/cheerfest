import { _ as _sfc_main$5, a as _sfc_main$6 } from "./pGzzZDVa.js";
import { N as resolveDirective, B as openBlock, C as createElementBlock, D as createBaseVNode, l as unref, R as createBlock, I as Fragment, J as renderList, Q as withDirectives, H as createTextVNode, E as toDisplayString, F as createVNode, O as normalizeClass, i as ref, o as onMounted, Z as onUnmounted, G as withCtx, d as defineComponent, $ as vShow, S as renderSlot } from "./CvP-Pp3N.js";
...
const docs = [{ "href": "/docs/policy.pdf", "label": "Политика конфиденциальности" }, { "href": "/docs/agreement.pdf", "label": "Отказ от претензий" }, { "href": "/docs/agreement-child.pdf", "label": "Отказ от претензий ребенка" }, { "href": "/docs/reglament4.pdf", "label": "Регламент соревнований" }];
const footerData = {
  type,
  title,
  contacts,
