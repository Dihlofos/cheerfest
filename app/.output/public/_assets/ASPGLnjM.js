                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(duplicatedEvents.value, (event, index) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("div", _hoisted_7$5, [
                        ...
                        createBaseVNode("div", _hoisted_9$2, toDisplayString(event.time), 1),
                        createBaseVNode("div", _hoisted_10$1, toDisplayString(event.description), 1)
                      ])
                    ]);
                  }), 128))
                ])
...
const type$5 = "nominations";
const title$5 = "Номинации";
...
const type$4 = "participants";
const title$4 = "Кто уже участвует";
const cards$1 = [{ "name": "НАЗВАНИЕ\nКОМАНДЫ", "photo": "/images/shared/cheerleaders-placeholder.jpg" }, { "name": "НАЗВАНИЕ\nКОМАНДЫ", "photo": "/images/shared/cheerleaders-placeholder.jpg" }, { "name": "НАЗВАНИЕ\nКОМАНДЫ", "photo": "/images/shared/cheerleaders-placeholder.jpg" }, { "name": "НАЗВАНИЕ\nКОМАНДЫ", "photo": "/images/shared/cheerleaders-placeholder.jpg" }, { "name": "НАЗВАНИЕ\nКОМАНДЫ", "photo": "/images/shared/cheerleaders-placeholder.jpg" }];
...
const cards = [{ "name": "иМЯ\nфАМИЛИЯ", "photo": "/images/shared/girl-placeholder.png" }, { "name": "иМЯ\nфАМИЛИЯ", "photo": "/images/shared/girl-placeholder.png" }, { "name": "иМЯ\nфАМИЛИЯ", "photo": "/images/shared/girl-placeholder.png" }, { "name": "иМЯ\nфАМИЛИЯ", "photo": "/images/shared/girl-placeholder.png" }, { "name": "иМЯ\nфАМИЛИЯ", "photo": "/images/shared/girl-placeholder.png" }];
const juryData = {
  type: type$3,
  title: title$3,
  cards
...
const timeBadge = "C ХХ:ХХ до ХХ:ХХ";
const items$1 = [{ "name": "Зона разминки", "description": "Подготовка к мастер-классам и выступлениям", "icon": "/images/shared/icon-stretch.svg" }, { "name": "Зона чирлидинга", "description": "Мастер-классы и показательные выступления", "icon": "/images/shared/icon-cheerleading.svg" }, { "name": "Зона спортивных танцев", "description": "Зумба, бачата, фит-рок и рок-н-ролл", "icon": "/images/shared/icon-children.svg" }, { "name": "Пространство для батлов", "description": "Соревнования среди любителей", "icon": "/images/shared/icon-swords.svg" }, { "name": "Мейкап и кастомизация костюмов", "description": "Бьюти-зона для создания танцевального образа", "icon": "/images/shared/icon-costumes.svg" }, { "name": "Зона мастер-классов на льду", "description": "Открытые занятия и показательные выступления", "icon": "/images/shared/icon-ice.svg" }, { "name": "Фотозоны", "description": "Тематические локации для фотографий", "icon": "/images/shared/icon-photo.svg" }];
const locationsData = {
  type: type$2,
  title: title$2,
  timeBadge,
...
const logos = [{ "src": "/images/partners/mossport.svg", "alt": "Мосспорт" }, { "src": "/images/partners/mossport.svg", "alt": "Партнёр" }, { "src": "/images/partners/mossport.svg", "alt": "Партнёр" }, { "src": "/images/partners/mossport.svg", "alt": "Партнёр" }, { "src": "/images/partners/mossport.svg", "alt": "Партнёр" }];
const partnersData = {
  type: type$1,
  title: title$1,
  logos
